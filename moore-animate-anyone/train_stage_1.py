...
from datasets.jafarin import JafarinImageDataset
...
from utils.util import delete_additional_ckpt, import_filename, seed_everything
...
def log_validation(
    ...
    ref_image_paths = [
        "../datasets/TikTok_dataset/TikTok_dataset/00002/images/0001.png",
        "../datasets/TikTok_dataset/TikTok_dataset/00003/images/0001.png",
    ]
    pose_image_paths = [
        "../datasets/TikTok_dataset/TikTok_dataset/00002/densepose/0001.png",
        "../datasets/TikTok_dataset/TikTok_dataset/00003/densepose/0001.png",
    ]
...
def main(cfg):
    ...
    train_dataset = JafarinImageDataset(
        '../datasets/TikTok_dataset/TikTok_dataset'
    )
                    ...
                    if accelerator.is_main_process:
                        ...
                        for sample_id, sample_dict in enumerate(sample_dicts):
                            ...
                            with TemporaryDirectory() as temp_dir:
                                out_file = f"{temp_dir}/{global_step:06d}-{sample_name}.gif"
                                img.save(out_file)
                                wandb.log({"validation_sample": wandb.Image(out_file)})
